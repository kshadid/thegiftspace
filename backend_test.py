...
class RestoredEndpointsTester:
    ...
    def run_restored_endpoints_tests(self):
        ...
        self.test_8_owner_get_contributions()
        self.test_9_owner_get_audit_logs()
        self.test_10_admin_get_registry_detail()
        self.test_11_admin_get_contributions()
        self.test_12_admin_get_audit_logs()
        self.test_13_admin_lock_registry()
        self.test_14_verify_owner_put_returns_423()
        self.test_15_verify_funds_upsert_returns_423()
        self.test_16_admin_unlock_registry()
        self.test_17_verify_write_works_after_unlock()
        self.test_18_verify_api_prefix_and_jwt()
